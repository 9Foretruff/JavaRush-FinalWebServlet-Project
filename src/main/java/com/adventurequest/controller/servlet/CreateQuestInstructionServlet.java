...
@WebServlet("/createQuestInstruction")
public class CreateQuestInstructionServlet extends HttpServlet {
    private static final Logger LOGGER = LoggerFactory.getLogger(ProfileServlet.class);
    private static final String CREATE_QUEST_INSTRUCTION = "creation-quest-instruction";

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        LOGGER.debug("User: {} get the profile page", UserSessionHelper.getUsername(req.getSession()));
        req.getRequestDispatcher(JspHelper.get(CREATE_QUEST_INSTRUCTION)).forward(req, resp);
    }
