...
<head>
    ...
    <title>Adding Quest Success</title>
    <link rel="stylesheet" type="text/css" href="css/adding-quest-success.css">
</head>
<body>
<h1 class="neon-title">Adding Quest Success</h1>
<div class="container">
    <div class="login-table">
        <p>Quest successfully added</p>
